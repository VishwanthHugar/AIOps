...
from utils import normalize_df, plot_metric_with_anomalies
...
def main():
    ...
    if st.sidebar.button("Run Anomaly Detection on Top Features"):
        try:
            kpi_file_path = get_latest_kpi_file("./test_data")
            model_path = "./model/iforest_single.pkl"
            ...
            if not os.path.exists(feature_ranking_csv):
                ...
                anomaly_file_path = os.path.join(os.getcwd(), f"df_with_anomalies_{timestamp}.csv")
