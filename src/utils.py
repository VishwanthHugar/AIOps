...
def read_config(config_file="config.txt"):
    """
    Reads a simple key=value config file and returns a dictionary of values.
...
# Optional helper to get specific keys with defaults
def get_config_value(key, default=None, config_file="config.txt"):
